...
{
    private readonly SyncOne.Services.ConfigurationService _configService;
    private SyncOne.Models.AppConfig _config;
    private ObservableCollection<SyncOne.Models.PhoneNumberFilter> _allowedNumbers;
    ...
    public SyncOne.Models.AppConfig Config
    {
        get => _config;
        set
        {
    ...
    public ConfigurationViewModel(SyncOne.Services.ConfigurationService configService)
    {
    ...
    private async Task RemoveNumberAsync(SyncOne.Models.PhoneNumberFilter filter)
    {
        try
        {
